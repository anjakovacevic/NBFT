...
This project implements a simulation of the NBFT consensus algorithm proposed by the paper Improved Fault Tolerant Consensus Based on the PBFT Algorithm.
